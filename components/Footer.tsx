        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="col-span-2 space-y-4">
            ...
            <nav aria-label="Social links" className="flex gap-4">
              <Link href="#" aria-label="Twitter" className="text-slate-400 hover:text-slate-600 transition-colors">
                <Twitter className="h-5 w-5" />
              </Link>
              <Link href="#" aria-label="GitHub" className="text-slate-400 hover:text-slate-600 transition-colors">
