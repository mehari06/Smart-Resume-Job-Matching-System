...
import { Search, Users, FileText, Download, Eye, ChevronLeft, ChevronRight, SlidersHorizontal, ArrowLeft, RefreshCw, Mail, Phone, MapPin, GraduationCap } from "lucide-react";
...
export default function ApplicantsPage() {
  ...
  const filteredApplicants = useMemo(() => {
    return applicants.filter((a) => {
      ...
      return userName.includes(search) || jobTitle.includes(search) || company.includes(search);
    });
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center">
                ...
                <div className="flex items-center gap-6 border-t border-slate-50 pt-4 md:border-none md:pt-0">
                  <div className="flex flex-col items-center gap-1">
                    <CircularScore value={a.score} size="md" className="scale-90" />
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Match</span>
                  </div>
                  
                  <div className="flex flex-col gap-2 min-w-[140px]">
                    <Button className="h-9 w-full rounded-xl bg-indigo-600 hover:bg-indigo-700 shadow-md shadow-indigo-500/20" asChild>
